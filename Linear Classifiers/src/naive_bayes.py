...
# Driver code
# training_sets = ["data/data_set_1/train",  "data/data_set_2/enron1/train", "data/data_set_3/enron4/train"]
# test_sets = ["data/data_set_1/test" , "data/data_set_2/enron1/test", "data/data_set_3/enron4/test"]
# 
# for x,y  in zip(training_sets, test_sets):
#     then = time.time()
...
#     NB.train(x)
#     print(NB.prior)
# #     print(NB.conditional_probability)
#     NB.test_multinomial_nb(y)
#     now = time.time()
#     print( "=== Finished in ", now - then, " sec")
